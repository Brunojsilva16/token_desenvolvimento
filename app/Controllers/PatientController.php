...
class PatientController extends BaseController
{
    ...
    public function store()
    {
        ...
        // CAPTURA DA ORIGEM (RADIO BUTTON)
        // Como é Radio, vem apenas uma string ("Organico" ou "Marketing") ou null
        ...
        $dados = [
            ...
            'origem' => $origem // Passa a string diretamente
        ];
    ...
    /**
     * API JSON para o Autocomplete (BLINDADA)
     */
