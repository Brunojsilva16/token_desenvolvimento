...
{
    // ... métodos create, store, history, edit, update mantidos ...
    // Vou colocar apenas o método PRINT atualizado para brevidade, 
    // mas se for copiar o arquivo todo, mantenha os outros métodos.
    // Abaixo o arquivo COMPLETO com a correção no print().
    ...
    public function print()
    {
        ...
        if ($token) {
            // Busca as sessões vinculadas
            $sessoes = $tokenModel->getSessoes($id);
            
            // Carrega a view. Como estamos usando require direto no arquivo, 
            // as variáveis $token e $sessoes estarão disponíveis lá.
